...
<template>
  <div class="supplies">
    ...
    <u-popup
        v-if="route.name === 'SuppliesWarehouseCreate' && getSuppliesWarehouse.length && loading"
    ...
    <u-popup
        v-if="route.name === 'SuppliesWarehouseUpdate' && getSuppliesWarehouse.length && loading"
