...
<template>
  <div class="graphics">
    ...
    <div class="graphics__list" v-if="getGraphics">
      <p class="graphics__title">Графики за:
        {{
      ...
      <p class="graphics__sub-title">Общие расходы по видам товаров:</p>
      <p class="graphics__sub-title">Товары:</p>
      <p class="graphics__text" v-for="item in getGraphics.goods">
      ...
      <p class="graphics__sub-title">Расходники:</p>
      <p class="graphics__text" v-for="item in getGraphics.consumable">
        <b>{{ item.title }}: </b> {{ item.quantity }} шт.
      </p>
      <p class="graphics__sub-title">Коробки и магниты:</p>
      <p class="graphics__text" v-for="item in getGraphics.other">
        <b>{{ item.title }}: </b> {{ item.quantity }} шт.
      </p>

      <p class="graphics__sub-title">Детальная информация:</p>
      <u-card
      ...
      >
        ...
        >
          ...
          >
            <p class="graphics__title">Графики по дням</p>
            <Chart
          ...
          >
            <p class="graphics__title">Графики по неделям</p>
            <Chart
                class="graphics__picture"
          ...
          >
            <p class="graphics__title">Графики по месяцам</p>
            <Chart
                class="graphics__picture"
          ...
          >
            <p class="graphics__title">Графики по годам</p>
            <Chart
                class="graphics__picture"
      ...
      >
        ...
        >
          ...
          <p class="graphics__text" v-if="+item.orders">
            <b>Всего заказов: </b> {{ item.orders }}
          </p>
          <p class="graphics__text" v-if="+item.orders">
            <b>Процент от заказов с участием продута: </b> {{ (100 / +getGraphics.orders.count * +item.orders).toFixed(2) }}%
          </p>
          <div v-if="item.types.length">
            ...
            >
              <p class="graphics__text graphics__text--bold graphics__text--big">{{ type?.count }}
                {{ item.measure }}</p>
              <p class="graphics__text">
              ...
              <p class="graphics__text" v-if="+item.orders">
                <b>Процент от заказов с участием товара: </b> {{ (100 / +getGraphics.orders.count * +type.orders).toFixed(2) }}%
              </p>
              <p class="graphics__text">
            ...
            >
              ...
              >
                ...
                >
                  <p class="graphics__sub-title">{{ type.count }} {{ item.measure }}</p>
                  <Chart
                      class="graphics__picture"
