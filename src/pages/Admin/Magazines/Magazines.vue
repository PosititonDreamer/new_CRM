  ...
  <div class="magazines">
    ...
    <template v-if="computedAllMagazines?.goods.length">
      ...
      <div class="magazines__wrapper">
        <div class="magazines__table " :style="`--columns: ${computedAllMagazines.show.goods.filter(item => item).length}`">
          <div class="magazines__row magazines__row--head magazines__row--goods">
            ...
            <template
                v-for="(head, key) in computedMagazinesHead"
            >
              <div
                  v-if="computedAllMagazines.show.goods[key]"
                  :class="['magazines__item magazines__item--head', {'magazines__item--color-red': head.supply_type === 'outcome','magazines__item--color-green': head.supply_type === 'income' }]"
                  :key="`goods-${head.date}`">
                {{ head.date }}
                <span v-if="head.type">
              {{ head.type }}
          ...
          <div class="magazines__row  magazines__row--goods" v-for="product in computedAllMagazines?.goods"
            ...
            <template v-for="good in product.goods">
              ...
              <template
                  v-for="(balance, key) in good.list"
              >
                <div
                    v-if="computedAllMagazines.show.goods[key]"
    ...
    <template v-if="computedAllMagazines?.weight.length">
      ...
      <div class="magazines__wrapper">
        <div class="magazines__table " :style="`--columns: ${computedAllMagazines.show.weight.filter(item => item).length}`">
          <div class="magazines__row magazines__row--head">
            ...
            >
              <div
                  v-if="computedAllMagazines.show.weight[key]"
                  :class="['magazines__item magazines__item--head', {'magazines__item--color-red': head.supply_type === 'outcome','magazines__item--color-green': head.supply_type === 'income' }]"
              >
                {{ head.date }}
                <span v-if="head.type">
          ...
          <div class="magazines__row" v-for="product in computedAllMagazines.weight">
            ...
            <template
                v-for="(balance, key) in product.goods.list"
            >
              <div
                  v-if="computedAllMagazines.show.weight[key]"
                  :class="[`magazines__item magazines__item--hover magazines__item--color-${balance.type}`]"
    ...
    <template v-if="computedAllMagazines?.consumable.length">
      ...
      <div class="magazines__wrapper">
        <div class="magazines__table " :style="`--columns: ${computedAllMagazines.show.consumable.filter(item => item).length}`">
          <div class="magazines__row magazines__row--head">
            <div class="magazines__item magazines__item--head">
              Название
            </div>
            ...
            >
              <div
                  v-if="computedAllMagazines.show.consumable[key]"
                  :class="['magazines__item magazines__item--head', {'magazines__item--color-red': head.supply_type === 'outcome','magazines__item--color-green': head.supply_type === 'income' }]"
              >
                {{ head.date }}
                <span v-if="head.type">
          ...
          <div class="magazines__row" v-for="product in computedAllMagazines.consumable">
            ...
            <template
                v-for="(balance, key) in product.goods"
            >
              <div
                  v-if="computedAllMagazines.show.consumable[key]"
                  :class="[`magazines__item magazines__item--hover magazines__item--color-${balance.type}`]"
    ...
    <template v-if="computedAllMagazines?.other.length">
      ...
      <div class="magazines__wrapper">
        <div class="magazines__table " :style="`--columns: ${computedAllMagazines.show.other.filter(item => item).length}`">
          <div class="magazines__row magazines__row--head">
            <div class="magazines__item magazines__item--head">
              Название
            </div>
            ...
            >
              <div
                  v-if="computedAllMagazines.show.other[key]"
                  :class="['magazines__item magazines__item--head', {'magazines__item--color-red': head.supply_type === 'outcome','magazines__item--color-green': head.supply_type === 'income' }]"
              >
                {{ head.date }}
                <span v-if="head.type">
