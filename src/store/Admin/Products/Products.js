...
export const Products = defineStore('Products', () => {
    ...
    const createProduct = async ({title, show_title, measure_unit, client_title, weight}) => {
    ...
    const updateProduct = async ({title, show_title, measure_unit, sort, id, client_title, weight}) => {
